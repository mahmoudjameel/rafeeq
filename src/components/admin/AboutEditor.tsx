...
const AboutEditor: React.FC<AboutEditorProps> = ({ db, showStatus }) => {
  const [formData, setFormData] = useState({
    title: 'عن rfeeq رفيق للتقسيط | راحتك أولوية',
    subtitle: 'لماذا rfeeq رفيق للتقسيط؟',
    description: 'rfeeq رفيق للتقسيط هي شركة رائدة في مجال التقسيط المريح في المملكة العربية السعودية. نؤمن بأن الحياة يجب أن تكون مريحة وخالية من الضغوط المالية.'
  });
