...
const ReviewsEditor: React.FC<ReviewsEditorProps> = ({ db, showStatus }) => {
  const [formData, setFormData] = useState({
    ...
    description: 'اكتشف ما يقوله عملاؤنا عن تجربتهم مع rfeeq رفيق للتقسيط',
    reviews: [
      {
        text: 'تجربة رائعة مع rfeeq رفيق للتقسيط! حصلت على iPhone جديد بتقسيط سهل وميسر. الموافقة كانت فورية والخدمة ممتازة. أنصح الجميع بالتجربة!',
        name: 'أحمد محمد',
        city: 'الرياض'
      },
      {
        text: 'rfeeq رفيق للتقسيط غير حياتي! حصلت على جميع الأجهزة المنزلية بتقسيط ممتاز. الأسعار منافسة والخصومات كبيرة. شكراً لكم!',
        name: 'سارة أحمد',
        city: 'جدة'
      },
      {
        text: 'خدمة عملاء ممتازة! فريق rfeeq رفيق للتقسيط ساعدني في اختيار أفضل الأجهزة بأسعار مناسبة. التقسيط سهل والموافقة سريعة.',
        name: 'محمد علي',
        city: 'الدمام'
      },
      {
        text: 'rfeeq رفيق للتقسيط منصة موثوقة وممتازة! حصلت على iPad بتقسيط سهل. الموافقة فورية والخدمة سريعة. شكراً لكم!',
        name: 'فاطمة حسن',
        city: 'مكة'
      }
    ]
      ...
      if (docSnap.exists()) {
        ...
        if (data.reviews) {
          setFormData({
            ...
            description: data.reviews.description || 'اكتشف ما يقوله عملاؤنا عن تجربتهم مع rfeeq رفيق للتقسيط',
