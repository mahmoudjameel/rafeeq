      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-10 text-center">
            <h2 className="cta-title">{websiteData.cta?.title || 'rfeeq رفيق للتقسيط مو بس تقسيط!'}</h2>
            ...
            <div className="text-center">
              <a 
                href={`https://wa.me/${websiteData.whatsappNumber?.replace('+', '') || '972592799888'}?text=مرحباً، أريد معلومات عن تقسيط الأجهزة مع rfeeq رفيق للتقسيط`}
                target="_blank" 
