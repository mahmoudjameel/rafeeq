...
const SEOManager: React.FC<SEOManagerProps> = ({
  ...
  const defaultTitle = websiteData.hero?.title || "rfeeq رفيق للتقسيط - تقسيط مريح وسهل للأجهزة الإلكترونية";
  ...
  const defaultKeywords = "تقسيط، جوالات، لابتوبات، أجهزة إلكترونية، السعودية، rfeeq رفيق للتقسيط";
  const defaultImage = "/Test.jpeg";
  const defaultUrl = "/";

  // Enhanced title for better browser tab display
  const enhancedTitle = websiteData.hero?.title 
    ? `${websiteData.hero.title} | rfeeq رفيق للتقسيط`
    : "rfeeq رفيق للتقسيط | تقسيط الأجهزة الإلكترونية في السعودية";
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="rfeeq رفيق للتقسيط" />
      ...
      <meta name="application-name" content="rfeeq رفيق للتقسيط" />
      <meta name="apple-mobile-web-app-title" content="rfeeq رفيق للتقسيط" />
      <meta name="msapplication-TileTitle" content="rfeeq رفيق للتقسيط" />
      ...
      <meta property="og:site_name" content="rfeeq رفيق للتقسيط" />
      ...
      {/* Windows Tiles */}
      <meta name="msapplication-TileImage" content="/Test.jpeg" />
